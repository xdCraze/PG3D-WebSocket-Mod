...
namespace IL2CPP
{
	...
	String* String::Create(const std::string_view& str)
	{
		return (String*)IMPORT::il2cpp_string_new(str.data());
	}

	String* String::Create(const std::wstring_view& str)
	{
		return (String*)IMPORT::il2cpp_string_new_utf16((IMPORT::Il2CppChar*)str.data(), (int32_t)str.size());
	}
