...
{
	const char* x = reinterpret_cast<const char*>(static_cast<uintptr_t>(a.X));
	const char* y = reinterpret_cast<const char*>(static_cast<uintptr_t>(a.Y));
	const char* z = reinterpret_cast<const char*>(static_cast<uintptr_t>(a.Z));
	char buffer[25];
